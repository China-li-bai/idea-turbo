...
abstract class PetLetterService {
  ...
  PetLetter? generateBirthdayLetter(
    String petId,
    String userId,
    PetContext context, {
    PersonalityProfile? personality,
  });
  PetLetter? generateAnniversaryLetter(
    String petId,
    String userId,
    int daysTogether,
    PetContext context, {
  ...
  PetLetter? generateWeeklyLetter(
    String petId,
    String userId,
    PetContext context,
    List<String> weekHighlights, {
    PersonalityProfile? personality,
  });
  PetLetter? generateLongAbsenceLetter(
    String petId,
    String userId,
  ...
  PetLetter? generateMilestoneLetter(
    String petId,
    String userId,
...
class DefaultPetLetterService implements PetLetterService {
  ...
  DefaultPetLetterService({
    this.config = const LetterConfig(),
  ...
  PetLetter? generateAnniversaryLetter(
    ...
    final letter = generateLetter(
      petId,
      userId,
      LetterOccasion.adoptionAnniversary,
      context,
      personality: personality,
    );
