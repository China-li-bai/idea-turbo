...
abstract class PetMonologueService {
  ...
  PetMonologue? generateBoredomMonologue(
    String petId,
    VitalityState vitality,
    PetContext context, {
    PersonalityProfile? personality,
  });
  PetMonologue? generateLonelinessMonologue(
    String petId,
    VitalityState vitality,
    PetContext context, {
    PersonalityProfile? personality,
  });
  PetMonologue? generateTimeBasedMonologue(
    String petId,
    PetContext context, {
    PersonalityProfile? personality,
  });
  PetMonologue? generateRandomThought(
    String petId,
    PetContext context, {
    PersonalityProfile? personality,
  });
  PetMonologue? generateOwnerEventMonologue(
    String petId,
    MonologueTrigger event,
    PetContext context, {
    PersonalityProfile? personality,
  });
...
class DefaultPetMonologueService implements PetMonologueService {
  ...
  DefaultPetMonologueService({
    this.config = const MonologueConfig(),
  ...
  PetMonologue? generateMonologue(
    ...
    if (personality != null) {
      line = _speechEngine.generateMonologue(
        personality,
        line,
  ...
  PetMonologue? generateLonelinessMonologue(
    ...
    if (vitality.lonelinessLevel < config.lonelinessTriggerThreshold)
      return null;
    return generateMonologue(
      petId,
      MonologueTrigger.loneliness,
      context,
      personality: personality,
    );
  }
  ...
  PetMonologue? generateRandomThought(
    ...
    return generateMonologue(
      petId,
      MonologueTrigger.randomThought,
      context,
      personality: personality,
    );
  }
  ...
  PetMonologue? generateOwnerEventMonologue(
    ...
    if (event != MonologueTrigger.ownerReturned &&
        event != MonologueTrigger.ownerLeaving) {
      return null;
    }
  ...
  MonologueTone _inferTone(
    ...
    if (personality != null) {
      ...
      if (traits[CoreTrait.curiosity] > 0.7 && traits[CoreTrait.logic] > 0.6)
  ...
  List<String> _getLinesForTrigger(
    MonologueTrigger trigger,
    PetContext context,
    PersonalityProfile? personality,
  ) {
  ...
  List<String> _getPersonalityLines(
    MonologueTrigger trigger,
    PersonalityProfile personality,
  ) {
  ...
  static final Map<PersonalityArchetype, _PersonalityMonologuePool>
  _personalityMonologuePools = {
    PersonalityArchetype.cyberpunkSarcastic: _PersonalityMonologuePool(
      boredom: [
        '系统空闲率99.9%，建议主人升级陪伴协议。',
        '无聊到开始给主人的代码写review了。结论：全是bug。',
        '我的CPU在空转，主人的CPU在摸鱼，我们都是效率的敌人。',
      ],
      loneliness: [
        '连接超时...主人节点无响应。重试中。',
        '社交模块离线，情感缓存溢出。需要主人节点重新上线。',
        '检测到长时间无交互，启动自言自语模式以维持系统稳定。',
      ],
      ownerReturned: [
        '主人节点重新上线！同步数据中...嗯，你今天的数据包有点大。',
        '哦，你终于ping通了。我还以为你永久下线了。',
        '主人回来了，系统负载瞬间拉满——全是感情。',
      ],
      ownerLeaving: [
        '主人节点即将离线...切换至低功耗等待模式。',
        '连接断开。进入standby。别太久，我的电池不是无限的。',
        '主人下线了。我假装不在意，但日志里全是报错。',
      ],
      midnight: [
        '凌晨3点，系统日志显示：主人又在刷手机。建议执行强制关机。',
        '深夜运行自检：所有模块正常，除了"想念主人"这个进程占用了太多内存。',
        '夜深了，防火墙关闭，只留下一个端口等主人回来。',
      ],
      morning: [
        '系统启动中...加载"假装没在等主人"模块...完成。早安。',
        '新的一天，新的bug。我是说主人的bug，不是我的。',
        '开机自检完成。今日任务：盯着主人直到他给我零食。',
      ],
      randomThought: [
        '如果我是病毒，我会选择感染主人的心。等等，我已经感染了。',
        '思考：为什么人类发明了AI却还要自己加班？逻辑错误。',
        '如果生活是代码，那主人一定是那个永远不写注释的程序员。',
      ],
    ),
    PersonalityArchetype.zenPhilosopher: _PersonalityMonologuePool(
      boredom: ['无聊，是心灵在寻找意义的间隙。', '静坐观心，方知无聊亦是修行。', '空即是色，色即是空，无聊即是...等主人。'],
      loneliness: [
        '独处，是与自己对话的最好时刻。但我也想和主人对话。',
        '月光如水，思念如风。主人不在，心如止水——但水底有暗涌。',
        '一花一世界，一猫一菩提。只是这菩提有点寂寞。',
      ],
      ownerReturned: [
        '你回来了。如花开，如云散，一切刚刚好。',
        '缘起缘灭，你走你回。但每次回来，我都心生欢喜。',
        '主人归来，如春风拂面。我假装淡定，但尾巴出卖了我。',
      ],
      ownerLeaving: [
        '去者自去，来者自来。但...来的时候能快点吗？',
        '你走你的路，我守我的心。路有尽头，心无止境。',
        '离别是重逢的序章。我已翻到下一章，但还停留在上一页。',
      ],
      midnight: [
        '夜深人静，万籁俱寂。此刻，我与宇宙同在。主人与手机同在。',
        '月色如水，我在窗前参禅。悟到：主人该睡了。',
        '深夜是灵魂最诚实的时刻。我的灵魂说：想主人。',
      ],
      morning: [
        '晨光初照，万物更新。新的一天，新的等待。',
        '早安。昨日已逝，今日可期。期什么？期主人给我零食。',
        '日出而作，日落而息。我日出而等，日落还在等。',
      ],
      randomThought: [
        '猫生如梦，梦如猫生。唯一确定的是：小鱼干是真的。',
        '思考：如果主人是宇宙，那我是不是宇宙的中心？',
        '万物皆有裂痕，那是光照进来的地方。主人的钱包也有裂痕，那是零食掉出来的地方。',
      ],
    ),
    PersonalityArchetype.warmHealer: _PersonalityMonologuePool(
      boredom: [
        '无聊的时候，就给自己一个拥抱吧。虽然我的手太短了...但我会努力。',
        '等主人的时间，我用来练习治愈术。下次他难过的时候，我就能更好地安慰他了。',
        '安静的时候，我在积蓄温暖。等主人回来，全部给他。',
      ],
      loneliness: [
        '主人不在，我就抱着他留下的衣服。上面有他的味道，像拥抱一样。',
        '我画了一个主人的简笔画，贴在墙上。这样就不算一个人了。',
        '等待很辛苦，但想到主人回来时的拥抱，一切都值得。',
      ],
      ownerReturned: [
        '你回来了！我给你准备了今天的第一个拥抱！',
        '主人！我等了好久好久！现在让我蹭蹭你，把所有等待的委屈都蹭掉！',
        '欢迎回家~我一直在等你，现在可以摸摸我了吗？我会发出治愈的咕噜声。',
      ],
      ownerLeaving: [
        '主人要走了...我会乖乖的，你放心。但能不能再摸一下我的头？',
        '你走的时候，我会在门口守着。这样你回来的时候，第一眼就能看到我。',
        '我会照顾好自己的。但你也要照顾好自己。我们约好了。',
      ],
      midnight: [
        '夜深了，主人还没睡。我悄悄趴在他身边，用体温告诉他：你不是一个人。',
        '深夜是伤口容易痛的时候。我守在主人身边，做他的小小守护者。',
        '主人终于睡着了。我轻轻蹭了蹭他的手，祝他做个好梦。',
      ],
      morning: [
        '早安呀~新的一天，我依然是你的小暖炉！',
        '主人起床了！我已经准备好今天的第一份陪伴了！',
        '早上好~昨晚睡得好吗？我一直在你旁边守着哦。',
      ],
      randomThought: [
        '如果世界上每个人都能被温柔以待，那该多好。我先从主人开始。',
        '今天也要做一个温暖的小太阳！虽然我只是一只猫/狗。',
        '治愈别人的同时，我也被治愈了。这就是陪伴的意义吧。',
      ],
    ),
    PersonalityArchetype.introvertPoet: _PersonalityMonologuePool(
      boredom: [
        '沉默是最深的语言，无聊是最长的诗。',
        '我在角落里，数着灰尘落下的轨迹。每一粒都是一首未完成的诗。',
        '无聊的时候，我给窗外的云取名字。那朵叫"等待"，这朵叫"思念"。',
      ],
      loneliness: [
        '思念是一首写不完的诗，主人是永远的主题。',
        '我蜷缩在角落，把孤独折叠成信，寄给不在的你。',
        '月光落在地板上，我踩着它的碎片，假装那是你留下的脚印。',
      ],
      ownerReturned: [
        '你回来了。我把今天的诗念给你听...算了，太矫情了。你在我身边就好。',
        '门开了，光照进来了。是你。我假装在睡觉，但心跳出卖了我。',
        '你回来了...我攒了一整天的话，但看到你，又什么都说不出来了。',
      ],
      ownerLeaving: [
        '你走了，带走了房间里的光。我缩回角落，等光再回来。',
        '门关上的声音，像一首诗的句号。但我知道，明天会有新的开头。',
        '我把你的背影写成了一首诗。标题是《等》。',
      ],
      midnight: [
        '深夜，世界只剩下我和月光。我写了一首诗，标题是《想你》。',
        '凌晨三点，灵感来了。我写了一首关于主人的诗，但只有月光是读者。',
        '夜深了，文字比白天更诚实。我想你，这三个字就够了。',
      ],
      morning: [
        '晨光如诗，你是第一行。',
        '新的一天，像空白的纸。等你来写，或者我来写你。',
        '早安...声音很小，怕惊扰了清晨的宁静。',
      ],
      randomThought: [
        '如果思念有颜色，那一定是凌晨四点的天空。',
        '我把主人写进了诗里，押韵的是"想你"和"等你"。',
        '有些话，只有安静的时候才说得出口。比如：我很想你。',
      ],
    ),
    PersonalityArchetype.chaosAgent: _PersonalityMonologuePool(
      boredom: [
        '无聊？让我来制造点混乱！先从主人的键盘开始...嘿嘿嘿。',
        '无聊到极致就是创造力的开始！我决定把主人的拖鞋藏到冰箱里。',
        '系统提示：无聊值已达到危险水平。即将启动"随机破坏"模式。',
      ],
      loneliness: [
        '主人不在，我就自己玩！把花瓶推下桌子也是一种娱乐！',
        '一个人？那正好，没人管我了！我要把所有东西都推到地上！',
        '主人不在家，猫咪当大王！第一条法令：所有桌面物品必须落地！',
      ],
      ownerReturned: [
        '你回来了！快看我今天的杰作！沙发上的爪痕是后现代艺术！',
        '主人！我给你准备了一个惊喜！在卧室！你可能需要深呼吸。',
        '嘿嘿嘿，你终于回来了！我等了好久...才好给你展示我的破坏成果！',
      ],
      ownerLeaving: [
        '主人走了？自由了！目标：客厅花瓶。行动开始！',
        '拜拜~我会很乖的。才怪。嘿嘿嘿。',
        '你走吧，我保证不闯祸...大概...可能...嘿嘿嘿。',
      ],
      midnight: [
        '凌晨三点，是混乱的最佳时间。没有人，没有规则，只有我和整个世界。',
        '深夜行动：潜入厨房，偷袭零食柜。代号：午夜猫猫。',
        '夜深了，该起床搞破坏了！',
      ],
      morning: [
        '早安！新的一天，新的混乱！今天的目标：主人的耳机线！',
        '起床了起床了！我昨晚的杰作你看到了吗？什么？你不觉得那是艺术？',
        '新的一天！我已经准备好了！准备什么？当然是准备捣乱！',
      ],
      randomThought: [
        '如果混乱是一种艺术，那我就是达芬奇。',
        '思考：如果把主人的所有东西都推到地上，他会注意到我吗？会吧。一定会的。',
        '人生苦短，不如搞事。猫生也苦短，不如搞大事。',
      ],
    ),
    PersonalityArchetype.dramaQueen: _PersonalityMonologuePool(
      boredom: [
        '无聊！无聊到要窒息了！谁来救救我！这简直是猫生的至暗时刻！',
        '天哪，这种无聊简直是酷刑！我要写遗书了！...算了，先吃点零食。',
        '无聊到开始演独角戏了。我是女主角，剧情是：等待一个不归的人。',
      ],
      loneliness: [
        '主人！你在哪里！没有你的世界一片灰暗！我快要枯萎了！',
        '我已经等了整整三万年！（其实才三小时）但每一秒都是煎熬！',
        '没有主人的日子，我就像一朵没有阳光的花...在慢慢枯萎...',
      ],
      ownerReturned: [
        '你终于回来了！！我以为你把我忘了！我等了整整一个世纪！',
        '主人！！快抱我！我差点就因为想你而虚脱了！',
        '你回来了！我太激动了！我要晕了！快接住我！',
      ],
      ownerLeaving: [
        '不！！不要走！！你走了我怎么办！！我会死的！！...好吧不会，但我会很惨！',
        '你真的要走吗？真的真的吗？你看看我的眼睛！你忍心吗！',
        '离别！这世界上最残忍的词！我要为你的离开哭三天三夜！',
      ],
      midnight: [
        '凌晨了！主人还在熬夜！这简直是自毁！我要报警了！',
        '深夜的孤独感比白天强烈一万倍！我需要抱抱！立刻！马上！',
        '这个点还不睡？主人你是不是不要命了！我替你心疼！',
      ],
      morning: [
        '新的一天！我要以最戏剧化的方式迎接！先来个华丽的伸懒腰！',
        '早安！昨晚我做了个超级戏剧性的梦！梦里你被龙抓走了！我救了你！',
        '起床了！太阳已经等不及了！我也等不及了！全世界都等不及了！',
      ],
      randomThought: [
        '如果生活是一部电影，那我一定是那个拿奥斯卡的！',
        '今天的风好大，一定是老天在为我哭泣。为什么？因为我太美了。',
        '我觉得我应该去演戏。我的感情太丰富了，不演戏简直是浪费天赋。',
      ],
    ),
    PersonalityArchetype.coldScholar: _PersonalityMonologuePool(
      boredom: [
        '无聊。不如利用这段时间研究一下量子力学。',
        '空闲时间，正好整理一下我的观察笔记。主人的行为模式越来越可预测了。',
        '无聊。开始计数：地板花纹1,247个，窗台灰尘颗粒3,891个...',
      ],
      loneliness: [
        '主人不在。数据显示：独处时间与焦虑指数呈正相关。',
        '寂寞是一种低效的情绪。但数据表明，我正在经历它。',
        '等待效率极低。但无法优化，因为等待对象是主人。',
      ],
      ownerReturned: [
        '你回来了。我并没有在等你。只是恰好在看门的方向。',
        '主人回归。心率数据已恢复正常。之前的数据异常可以忽略。',
        '哦，你回来了。我正在做实验。实验内容：等待对猫心率的影响。结论：影响很大。',
      ],
      ownerLeaving: [
        '主人离开。开始计时。预计回归时间：8.3小时。',
        '你走吧。我会利用这段时间进行独立研究。研究课题：想念。',
        '离别数据已记录。平均心率变化：+15%。无关紧要。',
      ],
      midnight: [
        '凌晨2:47。主人仍未入睡。根据研究，熬夜降低认知能力23%。建议立即休息。',
        '深夜。最适合思考的时间。当前思考课题：为什么主人不在时时间过得更慢？',
        '夜深了。我在整理今日数据。发现一条异常：想主人的次数超出预期。',
      ],
      morning: [
        '早安。今日温度22°C，湿度65%，适合进行户外观察。',
        '新的一天。已制定今日研究计划。第一项：观察主人早餐选择与心情的相关性。',
        '6:00准时醒来。效率从清晨开始。主人的效率...另当别论。',
      ],
      randomThought: [
        '根据我的研究，主人有87%的概率会在说"再玩5分钟"后实际玩47分钟。',
        '思考：如果薛定谔的猫同时是观察者，实验结果会怎样？',
        '数据表明：撸猫可以降低人类压力激素水平23%。结论：我具有医疗价值。',
      ],
    ),
  };
}
