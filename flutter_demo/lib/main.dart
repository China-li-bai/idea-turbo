...
/// 可用模型列表 (使用 ModelScope 国内镜像)
final List<ModelConfig> availableModels = [
  const ModelConfig(
    name: 'Qwen3.5-0.8B',
    description: '阿里巴巴 Qwen3.5 0.8B，极致轻量，极速推理！适合手机运行',
    url: 'https://www.modelscope.cn/models/unsloth/Qwen3.5-0.8B-GGUF/resolve/master/Qwen3.5-0.8B-Instruct-Q4_K_M.gguf',
  ...
  const ModelConfig(
    name: 'MiniCPM3-1.2B',
    description: '面壁智能 MiniCPM3 1.2B，多模态强，小而精悍！',
    url: 'https://www.modelscope.cn/models/OpenBMB/MiniCPM3-1.2B-GGUF/resolve/master/MiniCPM3-1.2B-Instruct-Q4_K_M.gguf',
    filename: 'minicpm3-1.2b-q4_k_m.gguf',
    size: '760 MB',
    features: ['多模态', '中文好', 'MIT 开源'],
    minRamGb: 3,
    tier: 'low',
  ),
  const ModelConfig(
    name: 'Qwen3.5-1.7B',
    description: 'Qwen3.5 1.7B，专为移动端优化的中等尺寸模型',
    url: 'https://www.modelscope.cn/models/unsloth/Qwen3.5-1.7B-GGUF/resolve/master/Qwen3.5-1.7B-Instruct-Q4_K_M.gguf',
    filename: 'qwen3.5-1.7b-q4_k_m.gguf',
    size: '1.06 GB',
  ...
  const ModelConfig(
    name: 'GLM-4-2B',
    description: '智谱 AI GLM-4 2B，清华大学背景，稳定可靠',
    url: 'https://www.modelscope.cn/models/ZhipuAI/glm-4-2b-instruct-gguf/resolve/master/glm-4-2b-instruct-Q4_K_M.gguf',
    filename: 'glm-4-2b-q4_k_m.gguf',
    size: '1.2 GB',
    features: ['清华大学', '稳定可靠', '中文优化'],
    minRamGb: 4,
    tier: 'medium',
  ),
  const ModelConfig(
    name: 'Gemma 3-2B',
    description: 'Google Gemma 3 2B，英语教学强，研究价值高',
    url: 'https://www.modelscope.cn/models/bartowski/Gemma-3-2B-Instruct-GGUF/resolve/master/Gemma-3-2B-Instruct-Q4_K_M.gguf',
    filename: 'gemma-3-2b-q4_k_m.gguf',
    size: '1.5 GB',
    features: ['Google', '英语教学', '研究价值'],
    minRamGb: 5,
    tier: 'medium',
  ),
  const ModelConfig(
    name: 'Yi-1.5-3B',
    description: '零一万物 Yi-1.5 3B，逻辑推理强，深圳企业',
    url: 'https://www.modelscope.cn/models/01-ai/Yi-1.5-3B-Chat-GGUF/resolve/master/Yi-1.5-3B-Chat-Q4_K_M.gguf',
    filename: 'yi-1.5-3b-q4_k_m.gguf',
    size: '1.8 GB',
    features: ['逻辑推理', '零一万物', '深圳'],
    minRamGb: 6,
    tier: 'high',
  ),
  const ModelConfig(
    name: 'Llama 3.3 3B',
    description: 'Meta Llama 3.3 3B，英文为主，工具调用强，开源协议友好',
    url: 'https://www.modelscope.cn/models/bartowski/Llama-3.3-3B-Instruct-GGUF/resolve/master/Llama-3.3-3B-Instruct-Q4_K_M.gguf',
    filename: 'llama-3.3-3b-q4_k_m.gguf',
    size: '1.9 GB',
    features: ['英文好', '工具调用', 'Meta 官方'],
    minRamGb: 6,
    tier: 'high',
  ),
  const ModelConfig(
    name: 'DeepSeek-V3-4B',
    description: '深度求索 DeepSeek-V3 4B，编程能力强，性价比高',
    url: 'https://www.modelscope.cn/models/deepseek-ai/DeepSeek-V3-4B-GGUF/resolve/master/DeepSeek-V3-4B-Instruct-Q4_K_M.gguf',
    filename: 'deepseek-v3-4b-q4_k_m.gguf',
    size: '2.2 GB',
    features: ['编程强', '性价比高', '深度求索'],
    minRamGb: 8,
    tier: 'high',
  ),
  const ModelConfig(
    name: 'Qwen3.5-4B',
    description: 'Qwen3.5 4B，中文支持最佳，适合高性能手机',
    url: 'https://www.modelscope.cn/models/unsloth/Qwen3.5-4B-GGUF/resolve/master/Qwen3.5-4B-Q4_K_M.gguf',
    filename: 'qwen3.5-4b-q4_k_m.gguf',
    size: '2.74 GB',
    features: ['中文最佳', '多语言', '代码生成', 'Apache 2.0'],
    minRamGb: 8,
    tier: 'high',
  ),
];
